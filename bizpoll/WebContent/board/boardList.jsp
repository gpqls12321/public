				...
				<td colspan="5" align="center">
					<form action="boardList.bizpoll" method="get">
						<select name="searchType" id="searchType">
							...
							<option value="t" <c:out value="${boardInfo.searchType == 'c' ? 'selected' : '' }"/>>내용</option>
							<option value="t" <c:out value="${boardInfo.searchType == 'w' ? 'selected' : '' }"/>>글쓴이</option>
							<option value="t" <c:out value="${boardInfo.searchType == 'tc' ? 'selected' : '' }"/>>제목+내용</option>
							<option value="t" <c:out value="${boardInfo.searchType == 'cw' ? 'selected' : '' }"/>>내용+글쓴이</option>
							<option value="t" <c:out value="${boardInfo.searchType == 'tcw' ? 'selected' : '' }"/>>제목+내용+글쓴이</option>
						</select>
